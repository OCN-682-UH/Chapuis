...
## What is new?   
This week I'm using the 'sf' package (new to me) and importing a shapefile to make a map (also new)!   
...
Joining our data with world map dataset (by country code because idk if the country names match)  
```{r}
